...
public class MachineInterfaceScreen extends HandledScreen<MGScreenHandler> {
        // A path to the gui texture. In this example we use the texture from the dispenser

        private static final Identifier TEXTURE = Identifier.ofVanilla("textures/gui/container/dispenser.png");

        public MachineInterfaceScreen(MGScreenHandler handler, PlayerInventory inventory, Text title) {
